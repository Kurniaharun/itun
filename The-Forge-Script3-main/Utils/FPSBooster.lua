...
local Settings = {
    ...
    Disable3DRendering = false,    -- ปิด 3D Rendering (สุดขีด) - DISABLED untuk mencegah blackscreen
    BlackScreenMode = false,       -- เปิดหน้าจอดำ (ประหยัด GPU + CPU) - DISABLED untuk mencegah blackscreen
